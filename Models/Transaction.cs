namespace SpendWise.Models
{
    public class Transaction
    {
        ...
        public string UserId { get; set; } // Id użytkownika, do którego należy ta transakcja bo IdentityUser
        ...
        public bool IsIncome { get; set; } = false; // czy transakcja jest przychodem
